...
if (@file_exists($maintenance = __DIR__.'/../storage/framework/maintenance.php')) {
    ...
    require $maintenance;
} elseif (@file_exists($maintenance = __DIR__.'/../private/student-discipline-system/storage/framework/maintenance.php')) {
    require $maintenance;
...
if (@file_exists($autoload = __DIR__.'/../vendor/autoload.php')) {
    ...
    require $autoload;
} elseif (@file_exists($autoload = __DIR__.'/../private/student-discipline-system/vendor/autoload.php')) {
    require $autoload;
...
if (@file_exists($bootstrap = __DIR__.'/../bootstrap/app.php')) {
    ...
    $app = require_once $bootstrap;
} elseif (@file_exists($bootstrap = __DIR__.'/../private/student-discipline-system/bootstrap/app.php')) {
    $app = require_once $bootstrap;
