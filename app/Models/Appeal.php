...
class Appeal extends Model {
    ...
    protected $fillable = [
        'AppealID', 'RecordID', 'StudentID', 'Reason', 'EvidencePath', 
        'AppealDate', 'Status', 'RestoredPoints', 'ReviewerID', 'ReviewDate', 'ReviewNotes'
    ];
    ...
    public function reviewer() { return $this->belongsTo(User::class, 'ReviewerID', 'UserID'); }
}